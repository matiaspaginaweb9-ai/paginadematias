    ...
    <div className="min-h-screen bg-stone-200" style={{backgroundImage: `url("data:image/svg+xml,%3Csvg width='60' height='60' xmlns='http://www.w3.org/2000/svg'%3E%3Cdefs%3E%3Cpattern id='a' patternUnits='userSpaceOnUse' width='60' height='60'%3E%3Cpath d='M0 0h60v60H0z' fill='%23f5f5f5'/%3E%3Cpath d='M0 0h60v60H0z' fill='%23e5e5e5'/%3E%3C/pattern%3E%3C/defs%3E%3Crect width='100%25' height='100%25' fill='url(%23a)'/%3E%3C/svg%3E")`}}>
      ...
      <div className="max-w-6xl mx-auto px-4 py-4 space-y-5">
        ...
        <div className="flex flex-col md:flex-row gap-6 items-start">
          <div className="w-full md:w-2/5">
            <div className="bg-yellow-400 px-4 py-2 mb-4">
              <p className="text-black font-bold text-base sm:text-lg">CAPACIDAD 8.000 KG</p>
            </div>
            <div className="space-y-2 text-gray-800 text-base sm:text-lg">
              <p>Lodos y otros</p>
              <p>Mínimo 6 horas</p>
            </div>
          </div>
        ...
        <div className="flex flex-col md:flex-row gap-6 items-start">
          ...
          <div className="w-full md:w-3/5 md:order-1">
            <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-gray-800 mb-4 leading-tight">RETROEXCAVADORA</h2>
            <div className="space-y-2 text-gray-800 text-base sm:text-lg">
        ...
        <div className="flex flex-col md:flex-row gap-6 items-start">
          ...
          <div className="w-full md:w-3/5">
            <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-gray-800 mb-4 leading-tight">EXCAVADORA</h2>
            <div className="bg-yellow-400 px-4 py-2 mb-4 inline-block">
              <p className="text-black font-bold text-base sm:text-lg">20 TON</p>
            </div>
            <div className="space-y-2 text-gray-800 text-base sm:text-lg">
        ...
        <div className="flex flex-col md:flex-row gap-6 items-start">
          ...
          <div className="w-full md:w-3/5 md:order-1">
            <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-gray-800 mb-4 leading-tight">GRÚA HORQUILA</h2>
            <div className="bg-yellow-400 px-4 py-2 mb-4 inline-block">
              <p className="text-black font-bold text-base sm:text-lg">DIESEL 3 TON</p>
            </div>
            <div className="space-y-2 text-gray-800 text-base sm:text-lg">
              <p>Incluye traslado en valor mes</p>
            </div>
        ...
        <div className="flex flex-col md:flex-row gap-6 items-start">
          ...
          <div className="w-full md:w-3/5">
            <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-gray-800 mb-4 leading-tight">GRÚA HORQUILA</h2>
            <div className="bg-yellow-400 px-4 py-2 mb-4 inline-block">
              <p className="text-black font-bold text-base sm:text-lg">GAS- BENCINA 2.5 TON</p>
            </div>
            <div className="space-y-2 text-gray-800 text-base sm:text-lg">
        ...
        <div className="flex flex-col md:flex-row gap-6 items-start">
          ...
          <div className="w-full md:w-3/5 md:order-1">
            <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-gray-800 mb-4 leading-tight">RODILLO TRIPULADO</h2>
            <div className="bg-yellow-400 px-4 py-2 mb-4 inline-block">
              <p className="text-black font-bold text-base sm:text-lg">BOMAG 120</p>
            </div>
            <div className="space-y-2 text-gray-800 text-base sm:text-lg">
              <p>Incluye traslado en valor mes</p>
              <p>Sin operador sin combustible</p>
        ...
        <div className="flex flex-col md:flex-row gap-6 items-start">
          ...
          <div className="w-full md:w-3/5">
            <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-gray-800 mb-4 leading-tight">MINICARGADOR</h2>
            <div className="bg-yellow-400 px-4 py-2 mb-4 inline-block">
              <p className="text-black font-bold text-base sm:text-lg">BOBCAT</p>
            </div>
            <div className="space-y-2 text-gray-800 text-base sm:text-lg">
              <p>Incluye operador, combustible y traslado en valor mes</p>
            </div>
