  ...
  return (
    ...
    >
      <div className="relative flex items-center gap-2 flex-row-reverse">
        ...
        <div className="bg-green-500 hover:bg-green-600 active:bg-green-700 rounded-full p-3 sm:p-4 shadow-2xl hover:shadow-green-500/50 transition-all duration-300 hover:scale-110 active:scale-95 group-hover:rotate-12 flex-shrink-0">
